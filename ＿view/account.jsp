			...
			<div class="col-md-6 col-md-offset-3">
				<div class="panel panel-login">
					<div class="panel-heading">
						<div class="row">
								<a href="/cinepic/account" class="active" id="register-form-link">계정관리</a>
							</div>
						</div>
						<hr>
					</div>
					<div class="panel-body">
						<div class="row">
							<div class="col-lg-12">
								<form id="accountTable" action="#"
									method="post" role="form" style="display: block;">
									<div class="form-group">
										<input type="text" name="id" id="id" tabindex="1"
											class="form-control" value="${user.id}" disabled="disabled"
											placeholder="4~10자로 입력하세요">
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										<input type="password" name="pw" id="pw" tabindex="2"
											class="form-control" placeholder="비밀번호(8~20자 이내)">
									</div>
									<div class="form-group">
										<input type="password" name="pwr" id="pwr" tabindex="2"
											class="form-control" placeholder="비밀번호 확인">
									</div>
									<div class="form-group">
										<input type="text" name="name" id="name" tabindex="2"
											class="form-control" placeholder="이름" value="${user.name}"
											disabled="disabled">
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										<div class="row">
											<div class="col-sm-6 col-sm-offset-3">
												<input type="button" name="register-submit" id="register-submit" tabindex="4" class="form-control btn btn-register" value="정보수정" onclick="update()"> 
											</div>
											<div class="col-sm-6 col-sm-offset-3">
												<input type="button" name="register-submit" id="register-submit1" tabindex="4" class="form-control btn btn-register" value="회원탈퇴" onclick="withdraw()">
											</div>
										</div>
									</div>
								</form>
