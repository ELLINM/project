			...
			<div class="col-md-6 col-md-offset-3">
				<div class="panel panel-login">
					<div class="panel-heading">
						<div class="row">
							<div class="col-xs-6">
								<a href="/cinepic/login" id="login-form-link">로그인</a>
							</div>
							<div class="col-xs-6">
								<a href="/cinepic/signup" class="active" id="register-form-link">회원가입</a>
							</div>
						</div>
						<hr>
					</div>
					<div class="panel-body">
						<div class="row">
							<div class="col-lg-12">
								<form id="login-Form" action="/cinepic/selectUser" method="post" role="form" style="display: none;">
									<div class="form-group">
								...
								<form id="register-form" action="/cinepic/insertUser" method="post" role="form" style="display: block;">
									<div class="form-group">
										<input type="text" name="id" id="id1" tabindex="1" class="form-control" placeholder="아이디를 입력하세요">
									</div>
									<div class="form-group">
										<input type="email" name="email" id="email" tabindex="1" class="form-control" placeholder="이메일을 입력하세요">
									</div>
									<div class="form-group">
